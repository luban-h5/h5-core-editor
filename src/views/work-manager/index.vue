<script>
// import PreView from '@core-editor/pages/preview';
// import Sidebar from './components/sidebar.vue'
import '@core-editor/components/core/styles/index.scss'
import LogoOfHeader from '@core-editor/components/common/header/logo.js'
import ExternalLinksOfHeader from '@core-editor/components/common/header/links.js'
import LangSelect from '@core-editor/components/common/header/LangSelect.vue'
